...
#| echo: false
#| warning: false
#| fig-cap: "Estimated total log10 clearance rate for each each of the five mussel zones (defined by quadrat positions) for each polygon (n = 1140)."
...
filtration_estimate %>%
  ...
  labs(x = "Tidal height (m)", y = "Log10 clearance rate (L/hr)") 
